...
{sample}/{sample}.expansionhunter_stranger_{panel}.bed | bed | Panel-specific bed file with the repeat expansions called by Expansion Hunter and annotated with stranger |
{sample}/{sample}.vep_annotated.vcf.gz | vcf.gz | DeepVariant VCF file annotated with VEP |
{sample}/{sample}.vep_annotated.hard-filtered.vcf.gz | vcf.gz | VEP annotated DeepVariant VCF file containing rare variants |
...
{sample}/cnv_sv/{sample}.pytor | pytor | CNVpytor read depth and SNP information file |
{sample}/cnv_sv/{sample}.manhattan.png | png | Manhattan plot for CNVpytor results |
{sample}/cnv_sv/{sample}.manta_diploidSV.vcf.gz | vcf.gz  | Compressed VCF for SV calls called by Manta |
{sample}/cnv_sv/{sample}.manta_diploidSV.vcf.gz.tbi | tbi | Index for the Manta VCF file |
{sample}/cnv_sv/{sample}.tiddit.vcf.gz | vcf.gz | Compressed TIDDIT VCF file |
{sample}/cnv_sv/{sample}.tiddit.vcf.gz.tbi | tbi | Index for the TIDDIT VCF file |
{sample}/cnv_sv/{sample}.melt.vcf.gz | vcf.gz | Compressed MELT VCF file containing mobile element insertions |
{sample}/cnv_sv/{sample}.melt.vcf.gz.tbi | tbi | Index for the MELT VCF file |
{sample}/cnv_sv/{sample}.scramble.vcf.gz | vcf.gz | Compressed Scramble VCF file containing mobile element insertions |
{sample}/cnv_sv/{sample}.scramble.vcf.gz.tbi | tbi | Index for the Scramble VCF file |
{sample}/cnv_sv/{sample}.svdb_merged.vcf.gz | vcf.gz | Compressed VCF containing the merge of SV and CNV calls from Manta, Tiddit, CNVpytor, MELT and Scramble |
{sample}/cnv_sv/{sample}.svdb_merged.vcf.gz.tbi | tbi | Index for the SVDB merged VCF file |
{sample}/cnv_sv/{sample}.svdb_merged.vep_annotated.vcf.gz | vcf.gz | Compressed SVDB merged VCF file annotated with VEP |
{sample}/cnv_sv/{sample}.svdb_merged.vep_annotated.vcf.gz.tbi | tbi | Index for the VEP annotated SVDB merged VCF file |
{sample}/cnv_sv/{sample}.svdb_merged.vep_annotated.filtered.vcf.gz | vcf.gz | Filtered version of the VEP annotated SVDB merged VCF |
{sample}/cnv_sv/{sample}.svdb_merged.vep_annotated.filtered.vcf.gz.tbi | tbi | Index for the filtered VEP annotated SVDB merged VCF file |
{sample}/cnv_sv/{sample}.cnv_sv.vcf.gz | vcf.gz | A filtered version of the compressed VCF containing the merge of SV and CNV calls from Manta, Tiddit, CNVpytor, MELT and Scramble |
{sample}/cnv_sv/{sample}.cnv_sv.vcf.gz.tbi | tbi | Index for the filtered SVDB merged VCF file |
