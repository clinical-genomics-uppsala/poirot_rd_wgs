...
{sample}/cnv_sv/{sample}.melt.softfiltered.vcf.gz | vcf.gz | Compressed MELT VCF-file containing mobile element insertions |
{sample}/cnv_sv/{sample}.scramble.softfiltered.vcf.gz | vcf.gz | Compressed Scramble VCF-file containing mobile element insertions |
