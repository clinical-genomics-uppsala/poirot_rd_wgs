...
{sample}/cnv_sv/{sample}.svdb_merged.vcf.gz | vcf.gz | Compressed VCF containing the merge of SV and CNV calls from Manta, CNVpytor, MELT and Scramble |
...
{sample}/cnv_sv/{sample}.cnv_sv.vcf.gz | vcf.gz | A filtered version of the compressed VCF containing the merge of SV and CNV calls from Manta, CNVpytor, MELT and Scramble |
